...
export default function Loading({ styles }) {
    return (
      <div className="flex justify-center content-center">
        <div className={`flex justify-center items-center h-40 w-40 bg-black/10  backdrop-blur-sm fixed top-1/2 rounded-md z-50`} >
          <div className=" spinner-border animate-spin inline-block w-10 h-10 border-4 border-gray-200 border-r-pink-800 rounded-full" role="status">
